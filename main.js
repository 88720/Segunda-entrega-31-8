...
/*esta función me esta dando problemas, no logro que se muestren correctamente el div y los
input creados, y entonces no puedo operar con el teléfono pedido, lo que traba procesos
posteriores*/
let contactoOut;
function socio() {
  ...
  if (socio == "si") {
    ...
    document.getElementById("pregunta").innerHTML =
      "Tenemos una a ctividad para vos, marca 1 para ver listado completo o 2 para buscar";
    if (contacto1) {
      //este console log simula el envío al Storage, no lo hago hasta no resolver lo anterior
